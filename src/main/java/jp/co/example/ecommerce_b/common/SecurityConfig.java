...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	http.formLogin() // ログインに関する設定
        ...
        .usernameParameter("inputEmail") // 認証時に使用するユーザ名のリクエストパラメータ名(今回はメールアドレスを使用)
	    .passwordParameter("inputPassword")// 認証時に使用するパスワードのリクエストパラメータ名
	    .defaultSuccessUrl("/user/login");//ログイン成功時の遷移先
